<?php
	...
	$showIcons = true;
	$dateFormat = 'd/m/y'; // Used in date() function
	$sizeDecimals = 1;
	...
	function getYear($year) {
		...
		if ($currentYear == 2019) {
		    ...
		    $string = "© 2019 - " . $currentYear;
		}
		return str_replace('{{year}}', $string, $year);
	}
...
<body <?php if ($alignment == 'left') echo 'id="left"' ?>>
	...
	<div id="wrapper">
		...
		<h1><a href="https://www.spyric.com/code" target="">Code & Stuff</a></h1>
		<a href="https://www.spyric.com" target="">
			<img src="https://www.spyric.com/code/media/Spyric%20Logo.svg" alt="Spyric Entertainment">
		</a>
		<h2><?php echo htmlentities(getTitle($title)) ?></h2>
		<h3><?php echo htmlentities(getTitle($subtitle)) ?></h3>
		...
		<p id="footer"><?php echo htmlentities(getYear($year)) ?> <a href="https://www.spyric.com" target="">Spyric Entertainment</a></p>
	</div>
